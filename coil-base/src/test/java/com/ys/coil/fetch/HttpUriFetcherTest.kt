...
class HttpUriFetcherTest {
	...
	fun after() {
		...
		diskCache.clear()
		diskCache.directory.deleteRecursively() // 새롭게 시작하도록 하십시오.
	}
