 ...
 */
interface DecoderNew {

    /**
     * [Factory.create]에서 제공하는 [SourceResult]를 디코딩하거나 'null'을 반환하여
     * 구성 요소 레지스트리의 다음 [DecoderNew].
     */
    ...
    fun interface Factory {
         ...
         *
         * 구현은 [result]의 [ImageSource]를 사용 **해서는 안 됩니다**. 이는 후속 디코더에 대한 호출이 실패할 수 있기 때문입니다. [ImageSource]는 [디코드]에서만 사용해야 합니다.
         *
